...
class ApplicationState:
    ...
    def set_current_conversation(self, conversation_id: Optional[str]) -> None:
        ...
        if conversation_id and self._orchestrator:
            try:
                conversation = self._orchestrator.get_conversation(
    ...
    def create_conversation(
        self, system_prompt: Optional[str] = None, model_id: Optional[str] = None
    ) -> str:
    ...
    def delete_conversation(self, conversation_id: str) -> bool:
        ...
        try:
            ...
            self.session.conversations = [
                c for c in self.session.conversations if c["id"] != conversation_id
            ]
